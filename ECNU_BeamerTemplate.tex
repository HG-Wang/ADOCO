...
%%%%----首页信息设置----%%%%
\title[AD-OCO Framework]{Asynchronous Decentralized Online Convex Optimization}
\subtitle{——A Novel Framework for Asynchronous Decentralized Online Learning}			
%%%%----标题设置

\author[Anonymous]{
  Anonymous Authors \texorpdfstring{\\}{, } {\small Conference/Journal Submission}
  }
%%%%----个人信息设置
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item We view either a prediction or a local update of any learner as an event, and use a virtual counter $t$ to index these events.
  ...
  \begin{figure}[h!]
    \centering
    \maybeincludegraphics[width=0.8\textwidth]{32172712-6d88-4961-9d21-4addd497fae3:image.png}
    \caption{An example of event indexing for two learners, where $N_1=2, N_2=1$.}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[h!]
    \centering
    \maybeincludegraphics[width=0.8\textwidth]{839efe1b-e043-44b7-8503-978e1919c182:截屏2025-11-05_19.42.56.png}
    \caption{The evolution of model $w_i$.}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[h!]
    \centering
    \maybeincludegraphics[width=0.6\textwidth]{91d5014d-5ff0-4c83-a8e6-d294a334f117:截图_20251106161456.png}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Compare AD-OGP with its synchronous counterpart (D-OGP) to show the advantage of asynchronization.
...
\begin{frame}
  ...
  \begin{figure}[h!]
    \centering
    \maybeincludegraphics[width=0.8\textwidth]{21f7f0f0-b57a-4a08-96ce-504e3e0842ba:image.png}
...
\begin{frame}
  \frametitle{Effectiveness of Asymmetric Gossiping and Instantaneous Model Averaging}
  \textbf{4.3.1 The Effectiveness of Asymmetric Gossiping}
  \begin{figure}[h!]
    \centering
    \maybeincludegraphics[width=0.8\textwidth]{944ac58f-0294-4c3a-88c4-fc0b5f2be828:image.png}
  ...
  \vspace{0.3cm}
  \textbf{4.3.2 The Effectiveness of Instantaneous Model Averaging}
  \begin{figure}[h!]
    \centering
    \maybeincludegraphics[width=0.8\textwidth]{2c019b85-bb61-4af6-b237-4d5a52671aed:image.png}
...
\begin{frame}
  ...
  \begin{figure}[h!]
    \centering
    \maybeincludegraphics[width=0.8\textwidth]{f2167018-059a-4570-aeb0-669cfb26a2be:image.png}
